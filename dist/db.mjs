...
async function setTopic(name, topicId) {
    if (!db.data) {
        throw new Error('UNINITIALIZED');
    }
...
async function setTopicLastMessageId(topicId, lastMessageId) {
    if (!db.data) {
        throw new Error('UNINITIALIZED');
    }
...
function getTopic(topicIdOrName) {
    if (!db.data) {
        throw new Error('UNINITIALIZED');
    }
...
async function setRosters(items) {
    if (!db.data) {
        throw new Error('UNINITIALIZED');
    }
...
export { getTopics, setTopic, getTopic, removeTopic, setTopicLastMessageId, setRosters, findRoster };
